...
Complete_data<-merge(data,data2,by= c("Manager.Name","Reference.Name","From","Mail.Type","Product.Name","Subscription","Audience.Size",  "Blast.Message","Distribution.Partner.Specific","Preferred.Partner","Producers.Only","Prospects.Only","Opened","Clicked","Bounced","Unsubscribed"))               
                     colnames(data)
