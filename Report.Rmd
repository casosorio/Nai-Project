...
validation_index <- createDataPartition(Complete_data$Opened, p=0.80, list=FALSE)

validation <- Complete_data[-validation_index,]

dataset <- Complete_data[validation_index,]
